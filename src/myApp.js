...
async function main() {
  say(
    "Hello! This program is designed to help assess which part of your body is currently feeling the most uncomfortable. Please respond to the following questions with 'yes' or 'no' only.",
  );
